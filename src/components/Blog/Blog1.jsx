                                    ...
                                    <div role="tabpanel" className="tab-pane active" id="about">
                                        <div className="about-information">
                                            ...
                                            <p>A very famous quote that we all have been listening from our childhood is "Health is wealth ", and as we grow older, we get to know the real value of this saying.
                                                ...
                                                As per the definition of the World Health Organization,  overweight and obesity are defined as abnormal or excessive fat accumulation that may impair health.
                                                According to the Stats as per 2021, 13% of adults in the world are obese and 39% of adults in the world are overweight. Also, one in every five children and adolescents are overweight.
